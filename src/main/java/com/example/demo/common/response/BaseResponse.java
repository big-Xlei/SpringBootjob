...
public class BaseResponse<T> {
    ...
    public static BaseResponse responseFail(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.SYSTEM_ERROR.getMsg() : msg);
        return resp;
    }
    ...
    public static BaseResponse responseTokenInvalid(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.TOKEN_ERROR.getMsg() : msg);
        return resp;
    }
    ...
    public static BaseResponse responseParamInvalid(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.PARAM_ERROR.getMsg() : msg);
        return resp;
    }
    ...
    public static BaseResponse responseMissRequestParam(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.MISSING_REQUEST_PARAM_ERROR.getMsg() : msg);
        return resp;
    }
    ...
    public static BaseResponse responseUnauthorized(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.UNAUTHORIZED.getMsg() : msg);
        return resp;
    }
    ...
    public static BaseResponse responseService(String msg) {
        ...
        resp.setMsg(msg == null || msg == "" ? ResponseCode.SERVICE_ERROR.getMsg() : msg);
        return resp;
    }
